      ...
      <div className="flex flex-col items-center justify-start px-6 space-y-6 mt-12">
        ...
        <div className="flex flex-col w-full max-w-sm">
          <ol className="list-decimal list-inside text-gray-600 text-sm leading-relaxed space-y-4">
            ...
            <li>Push off on the e-scooter to fold the kickstand up and press the ‘Go’ button gently.</li>
            <li>Release ‘Go’ button gently to reduce your speed or pull firmly on the brake levers.</li>
